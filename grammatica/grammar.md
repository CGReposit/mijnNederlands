...
1. [Overview of Verb Types](#overview-of-verb-types)  
2. [Regular Verbs](#regular-verbs)  
3. [Irregular Verbs](#irregular-verbs)  
4. [Auxiliary Verbs](#auxiliary-verbs)  
5. [Modal Verbs](#modal-verbs)  
6. [Separable and Inseparable Verbs](#separable-and-inseparable-verbs)  
7. [The Perfect and Imperfect Tenses](#the-perfect-and-imperfect-tenses)  
8. [Examples in Context](#examples-in-context)  
...
|------|--------------|----------|
| **Regular verbs** | Follow a predictable pattern in their conjugation | *werken* → *ik werk, jij werkt* |
| **Irregular verbs** | Change stem or vowels unpredictably | *zijn* → *ik ben, jij bent* |
...
1. Remove **-en** from the infinitive → *werk-*  
...
Regular verbs use either **‘t kofschip** rule** to decide the past ending:
...
|------|--------------|----------------|---------------|
| werken | k → in *’t kofschip* | werkte | werkten |
| leven | v → not in *’t kofschip* | leefde | leefden |
...
|------|----------|--------------|
| **hebben** | to have | Ik **heb gewerkt** — I have worked |
| **zijn** | to be | Ik **ben gegaan** — I have gone |
| **zullen** | will/shall | Ik **zal komen** — I will come |
...
|------|----------|----------|
| **kunnen** | can, to be able to | Ik **kan** zwemmen — I can swim |
| **mogen** | may, to be allowed to | Jij **mag** gaan — You may go |
| **willen** | to want | Wij **willen** eten — We want to eat |
| **moeten** | must, to have to | Ik **moet** werken — I must work |
| **zullen** | shall, will | Wij **zullen** komen — We will come |
...
- Learn verbs in **groups** (e.g., all verbs of motion, all modal verbs).  
- Use **flashcards** with the **infinitive**, **past tense**, and **past participle**.  
- Practice forming **sentences** — context improves memory.  
- Read simple Dutch texts and **highlight all verbs** you find.  
- Listen to Dutch podcasts or songs to absorb verb forms naturally.

---

## 📚 Recommended Resources

- [https://www.dutchgrammar.com](https://www.dutchgrammar.com)  
- [https://taalunie.org](https://taalunie.org)  
- *Essential Dutch Grammar* by Henry R. Stern  
- *Dutch Verb Conjugator* (mobile apps or online tools)
